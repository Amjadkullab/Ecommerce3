...
@section('title', \App\CPU\translate('add_type_contract'))
    ...
    <div class="content container-fluid">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page">{{\App\CPU\translate('add_type_contract')}}</li>
            </ol>
        </nav>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        {{ \App\CPU\translate('add_type_contract')}}
                    </div>
                                    ...
                                    @foreach(json_decode($language) as $lang)
                                        <div class="form-group {{$lang != $default_lang ? 'd-none':''}} lang_form"
                                            ...
                                            <input type="text" name="name[]" class="form-control"
                                                   placeholder="{{\App\CPU\translate('add_type_contract')}}" {{$lang == $default_lang? 'required':''}}>
                                        </div>
